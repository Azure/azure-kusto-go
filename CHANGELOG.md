...
## [Unreleased]
### Added
* Added new builder struct for safe building of KQL statements from variables without use of 'Unsafe' mode.
* Simpler handling of query parameters using new parameters struct. 
