...
// Dynamic represents a Kuston dynamic type.  Dynamic implements KustoValue.
type Dynamic struct {
	// Value holds the value of the type.
	Value string
	// Valid indicates if this value was set.
...
// Int represents a Kusto int type. Kusto int type's are int32 values.  Int implements KustoValue.
type Int struct {
	// Value holds the value of the type.
	Value int32
	// Valid indicates if this value was set.
...
// MarshalString marshals this type to the Kusto REST representation.
func (t *Timespan) MarshalString() string {
