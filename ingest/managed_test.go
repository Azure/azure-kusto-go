...
type testMgmtFunc func(t *testing.T, ctx context.Context, db string, query data.Statement, options ...data.MgmtOption) (*data.RowIterator, error)

func failIfQueuedCalled(t *testing.T, _ context.Context, _ string, query data.Statement, _ ...data.MgmtOption) (*data.RowIterator, error) {
...
func TestManaged(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			onMgmt: func(t *testing.T, ctx context.Context, db string, query data.Statement, options ...data.MgmtOption) (*data.RowIterator, error) {
				// .get ingestion resources is always called in the ctor
				if query.String() == ".get ingestion resources" {
