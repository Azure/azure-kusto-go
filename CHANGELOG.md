...
## [Unreleased]
### Added
* Created new Statement interface including both old Stmt and new statementBuilder struct for building queries
* Added new StatementQueryParameters struct for simple and safe handling of query parameters
### Changed
* Old Stmt struct to adhere new Statement interface 
